...
[Notion](https://notion.so/) Notion is a freemium productivity and note-taking web application

![Notion](/images/notion.png)

- The API URL is the root URL, for example: `https://api.notion.so/`.
- To create a new API client, go to `https://www.notion.so/my-integrations` click on "New Integration" and fill in all the need fields and select your board.
- Once submit, head to secrets and generate a secret which should be like that `secret_XXXXXX`
- Create a page then head to 
...
- To create a new API client, go to `https://www.notion.so/my-integrations` click on "New Integration" and fill in all the need fields and select your board.
- Once submit, head to secrets and generate a secret which should be like that `secret_XXXXXX`
- Create a page then click `...` on the top right corner
- Scroll down to `Add connections` and select your integration created in previous step 
